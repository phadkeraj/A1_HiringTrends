...
x = 1
abc=[]
df = pd.read_csv("C:/ADS/A1_HiringTrends/Data/Generated/By Algorithms/TF-IDF_top100.csv",header=None,names=["0","words","rate"])
#df = pd.read_csv("Z:/ADS/a/textrank_final.csv")
with open('C:/ADS/A1_HiringTrends/Data/Generated/By Algorithms/TF-IDF_top100.csv', newline='') as myFile:
...
df2_transposed2 = df2_transposed1.drop(df2_transposed1.index[1])
...
for o in range(o,count+1):
    df2_transposed2.iloc[o,3] = '2'
    df2_transposed2.iloc[o,1] = inst
    o+=1
df2_transposed2 = df2_transposed2.replace(np.nan, 0)
df2_transposed2.to_csv("C:/ADS/A1_HiringTrends/Data/Generated/By Algorithms/final_files/TF-IDF_final_file.csv",index=False, encoding='utf8')
